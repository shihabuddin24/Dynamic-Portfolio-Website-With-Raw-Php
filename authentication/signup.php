...
<body>
    <div class="app app-auth-sign-up align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="text" class="form-control m-b-md" placeholder="Enter Name" name="name" value= <?= (isset($_SESSION["old_name"])) ? $_SESSION["old_name"] : ''; unset($_SESSION["old_name"]);?> >
                
                <?php if(isset($_SESSION["name error"])) { ?>
                <div id="nameHelp" class="form-text m-b-md text-danger"><?php echo $_SESSION["name error"]?>*</div>
                ...
                <input id="SHIHAB_UDDIN" type="password" class="form-control" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="password" value= <?= (isset($_SESSION["old_password"])) ? $_SESSION["old_password"] : ''; unset($_SESSION["old_password"]);?>>
                <div class="my-2"><input type="checkbox" onclick="myFunction()">Show Password</div>
                ...
                <input type="password" class="form-control" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" name="c_password" value= <?= (isset($_SESSION["old_c_password"])) ? $_SESSION["old_c_password"] : ''; unset($_SESSION["old_c_password"]);?>>

                
                <?php if(isset($_SESSION["c_password error"])) { ?>
                <div id="c_passwordlHelp" class="form-text m-b-md text-danger"><?php echo $_SESSION["c_password error"]?>*</div>
                <?php } unset($_SESSION["c_password error"]) ?>
  ...
  var x = document.getElementById("SHIHAB_UDDIN");
  if (x.type === "password") {
    x.type = "text";
  } else {
    x.type = "password";
