                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                ...
                                <img src="./public/uploads/default/<?= $user['image'] ?>" alt="" style="height:835px; width=:700px;">
                                <?php else: ?>
                                <img src="./public/uploads/profile/<?= $user['image'] ?>" alt="" style="height:835px; width:700px;">
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img style="height: 600px; object-fit:cover " src="./public/uploads/protfolio/<?= $protfolio['image']?>" alt="img">
								</div>
								<div class="speaker-overlay">
									<span><?= $protfolio['subtitle']?></span>
									<h4><?= $protfolio['title']?></h4>
									<a href="./backend/protfolio/single.php?portid= <?= $protfolio['id']?>" class="arrow-btn">More information <span></span></a>
								</div>
							</div>
                        </div>
                        <?php endforeach ; ?>
