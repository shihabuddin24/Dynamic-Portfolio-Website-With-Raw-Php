...
if(isset($_GET['portid'])){
    ...
    $connect_select = mysqli_query($db_connect, $select_query);
    $protfolio = mysqli_fetch_assoc($connect_select);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="../../public/uploads/protfolio/<?=$protfolio['image']?>" alt="img">
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img style="height: 350px;" src="../../public/uploads/protfolio/<?=$protfolio['image']?>" alt="img">
                                            </div>
